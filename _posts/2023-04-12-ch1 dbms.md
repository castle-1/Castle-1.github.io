...
<h4>숫자형 데이터 타입</h4>
    <h5>정수형</h5>
        <table border = "1" width = "400", height="220" ,align = "left">
        <th>데이터타입</th>
        <th>바이트 수</th>
        <th>표현 가능한 숫자 범위</th>
        <tr>
...
<h5>실수형</h5>
<table border = "1" width = "400", height="110" ,align = "left">
        <th>데이터타입</th>
        <th>바이트 수</th>
        <th>표현 가능한 숫자 범위</th>
        <tr>
...
<h5>날짜형</h5>
<table border = "1" width = "500", height="190" >
        <th>데이터타입</th>
        <th>바이트 수</th>
        <th>특징</th>
        <tr>
